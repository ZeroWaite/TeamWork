...
public class FragmentNews extends Fragment {
            ...
            switch (msg.what) {
                case MSG:
                    ...
                    if (prettyGirlAdapter == null) {
                        prettyGirlAdapter = new ImgListAdapter(mList, FragmentNews.this.getActivity(),1);
                    } else {
                    ...
                    prettyGirlAdapter.setClickListener(new ImgListAdapter.MyClickListener() {
                        ...
                        public void onImageContentClick(int position) {
                            Intent intent = new Intent(FragmentNews.this.getActivity(), ContentActivity.class);
                            ...
                            Toast.makeText(FragmentNews.this.getActivity(), "这是图片内容" + mList.get(position).getUsername(), Toast.LENGTH_SHORT).show();
                        ...
                        public void onUserMsgClick(int position) {
                            ...
                            intent.putExtra("userHead", mList.get(position).getUserHead());
                            intent.putExtra("title", mList.get(position).getTitle());
                            Toast.makeText(FragmentNews.this.getActivity(), "这是用户信息" + position, Toast.LENGTH_SHORT).show();
                        }
                    });
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (newState == RecyclerView.SCROLL_STATE_IDLE) {
                    ...
                    if (lastVisiblePosition == (totalItemCount - 1) && isSlidingToLast) {
                        Toast.makeText(FragmentNews.this.getActivity(), "正在加载更多", Toast.LENGTH_SHORT).show();
                    }
                }
            }
    ...
    public void inteData() {
        demo_swiperefreshlayout = (SwipeRefreshLayout) FragmentNews.this.getActivity().findViewById(R.id.demo_swiperefreshlayout);
        //设置刷新时动画的颜色，可以设置4个
