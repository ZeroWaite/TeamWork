...
private String following_count;
    ...
    private String source;/* : xiaodaimeng.net*/
    private String created_at; /*: 1474248547  发布时间*/
    private String like_count; /*: 0  喜欢*/
    private String comment_count; /*: 0  评论*/
    private String repin_count;/* : 0  转发*/
    private String userHead; /*  图片*/
